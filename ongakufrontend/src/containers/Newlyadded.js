...
const Newlyadded = ({ logout, isAuthenticated }) =>{   
                    ...
                    <div className="col-xs-6 col-sm-6 col-md-10 col-lg-10 col-xl-10 p-0 m-0 mainsectioncontainer">  
                        <div className="p-0 m-0 col-sm-12">
                            ...
                            <div className="container-fluid m-0 p-0">
                                                ...
                                                songs.map((item, id)=>(
                                                    <>
                                                    {
                                                        ...
                                                        >
                                                            ...
                                                            <h6 className="text-center">{item.title} {id}</h6>
                                ...
                                {/* src="http://localhost:8000/media/af/03_Gallan_Goodiyaan_(Dil_Dhadakne_Do)_Farhan_Akhtar_320Kbps.mp3" */}
...
export default connect(mapStateToProps, { logout })(Newlyadded);